...
@Slf4j
@Accessors(prefix="_")
public class RequestQueryStringParamParser {
/////////////////////////////////////////////////////////////////////////////////////////
//  
/////////////////////////////////////////////////////////////////////////////////////////
...
//  CONSTRUCTORS
/////////////////////////////////////////////////////////////////////////////////////////
    public RequestQueryStringParamParser(final ServletRequest req) {
        _req = req;
        _requestCharset = Charset.defaultCharset();
        _serverCharset = Charset.defaultCharset();
    } 
    public RequestQueryStringParamParser(final ServletRequest req,final Charset requestCharset,
...
/////////////////////////////////////////////////////////////////////////////////////////
     ...
     * @exception ServletRequestParameterNotFoundException si el parametro no se encuentra o es una cadena vacía
     */
     ...
     * @return
     */
    public RequestQueryStringParamValueWrapper paramWithName(final String name) {
    	return new RequestQueryStringParamValueWrapper(name);
    }
/////////////////////////////////////////////////////////////////////////////////////////
//  WRAPPER
/////////////////////////////////////////////////////////////////////////////////////////
    @RequiredArgsConstructor(access=AccessLevel.PRIVATE)
    public class RequestQueryStringParamValueWrapper {
    	private final String _paramName;
    	
	    /**
	     * Returns a query string param as a String
	    ...
	    /**
	     * Returns a query string param as a String
	     * @param defValue the default value if the param is not present
	     * @return value as a String
	     */
    	public String asString(final String defValue) {
    		String value = _getParameterValueAsString(_paramName);
	    ...
	    private Boolean _asBoolean() {
	        ...
	        if ((value.equalsIgnoreCase("true")) ||
	            ...
	            log.error("The request query string param with name {} and value={} cannot be converted to a boolean value; returning default value",
	            		  _paramName,value);
	            return null;
	        }
	    }
	    /**
	     * Returns a query string param as a boolean
	     * The value can have values like:
	     *      true = true,on,yes,si,bai (case independent)
	     *      false = false,off,no,ez   (case independent)
	     * @return param value as a boolean
	     */
	    ...
	    public boolean asBoolean(final boolean defValue) {
	    	Boolean outBoolean = _asBoolean();
	    	return outBoolean != null ? outBoolean.booleanValue()
	    							  : defValue;
	    }
	    ...
	    /**
	     * Returns a query string param as a byte
	    ...
	    public byte asByte(final byte defValue) {
	        Byte outByte = _asByte();
	        return outByte != null ? outByte.byteValue()
	        					   : defValue;
	    }
	    private Character _asChar() {
	        String value = _getParameterValueAsString(_paramName);
	        if (value == null) return null;
	        return value.charAt(0);
	    }
	    /**
		 * Returns a query string param as a char
	     * @return
	     */
	    public char asChar() {
	    ...
	    public char asChar(final char defValue) {
	    	Character outChar = _asChar();
	    	return outChar != null ? outChar.charValue()
	    						   : defValue;
	    }
	    ...
	    /**
		 * Returns a query string param as a double
	     * @param defValue the default value if the param is not present
	     * @return
	     */
	    public double asDouble(final double defValue) {
	    	Double outDouble = _asDouble();
	    	return outDouble != null ? outDouble.doubleValue()
	    							 : defValue;
	    }
	    ...
	    /**
		 * Returns a query string param as a float
	     * @param defValue the default value if the param is not present
	     * @return
	     */
	    public float asFloat(final float defValue) {
	    	Float outFloat = _asFloat();
	    	return outFloat != null ? outFloat.floatValue()
	    							: defValue;
	    }
	    private Integer _asInteger() {
	    	String value = _getParameterValueAsString(_paramName);
	    	if (value == null) return null;
	    	return Integer.parseInt(value);
	    }
	    /**
		 * Returns a query string param as a int
	     * @return
	     */
	    ...
	    public int asInteger(final int defValue) {
	    	Integer outInt = _asInteger();
	    	return outInt != null ? outInt.intValue()
	    						  : defValue;
	    }
	    ...
	    /**
		 * Returns a query string param as a long
	     * @return
	     */
	    public long asLong() {
	    ...
	    public long asLong(final long defValue) {
	    	Long outLong = _asLong();
	    	return outLong != null ? outLong.longValue()
	    						   : defValue;
	    }
	    ...
	    /**
		 * Returns a query string param as a short
	     * @return
	     */
	    ...
	    public short asShort(final short defValue) {
	    	Short outShort = _asShort();
	    	return outShort != null ? outShort.shortValue()
	    						    : defValue;
	    }
    }
/////////////////////////////////////////////////////////////////////////////////////////
