...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    public HttpRequestQueryStringParamsWrapper(final ServletRequest req,final Charset requestCharset,
...
/////////////////////////////////////////////////////////////////////////////////////////
     ...
     * @return
     */
    public StringConverter paramWithName(final String name) {
    	return new StringConverter(_getParameterValueAsString(name));
    }
    /**
