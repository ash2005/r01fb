 ...
 *			</pre>
 * 		</li>
 * 		<li>Create a template for each of the extracted fields using {@link LuceneDocumentFactoryForIndexableModelObject}
 ...
 * the {@link LuceneDocumentFactoryForIndexableModelObject} like:
 * <pre class='brush:java'>
...
@RequiredArgsConstructor(access=AccessLevel.PRIVATE)
  class LuceneDocumentFactoryForIndexableModelObject 
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public Field createField(final IndexDocumentFieldID fieldId) {
		...
		Field field = LuceneDocumentFactoryForIndexableModelObject.createField(fieldCfg);
		if (field != null) {
