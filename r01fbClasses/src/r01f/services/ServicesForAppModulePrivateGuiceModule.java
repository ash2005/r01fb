...
public class ServicesForAppModulePrivateGuiceModule 
	...
	protected void configure() {
		...
		if (dbModulePresent) {
			this.expose(ServiceHandler.class)
				.annotatedWith(Names.named(_coreBootstrapDef.getCoreAppCodeAndModule().asString())); //	aa81b.grantedBenefits // aa14b.appointments / r01y.cataloguing
		}
